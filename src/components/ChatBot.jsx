...
- If asked about specific medications or treatments, encourage discussing with doctors
- For emergency situations, advise contacting emergency services
...
Please respond to the following query with these guidelines in mind.`
  ...
  const sendMessage = async () => {
    ...
    try {
      const response = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent?key=AIzaSyCy3s6h0J5Hq8T7W3c3Bv3Zy7kXy2BvQ1Wk`, {
        method: 'POST',
        headers: {
        ...
        <div className="chatbot-modal-overlay" onClick={() => setIsOpen(false)}>
          <div className="chatbot-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="chatbot-disclaimer">
              <p>⚠️ This AI is for informational purposes only and not a substitute for professional medical advice.</p>
            </div>
          </div>
        </div>
      )}
